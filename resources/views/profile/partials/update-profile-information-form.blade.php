  ...
  <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
    ...
    <div>
      ...
      <input
        ...
        aria-describedby="r_help" id="avatar" type="file" name="avatar"
        accept="image/png, image/jpg, image/jpeg">
      <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="r_help">.png or .jpg</div>
    </div>

    {{-- image --}}
    <div>
      <img class="w-20 h-20 rounded-full"
        src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('img/avatar_default.png') }}"
