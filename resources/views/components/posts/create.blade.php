    ...
    <div class="gap-4 mb-4 sm:grid-cols-2">
      <div class="mb-4">
        ...
        <input type="text" name="title" id="title"
          ...
          placeholder="Type post title" value="{{ old('title') }}">
        @error('title')
      ...
      <div class="sm:col-span-2">
        ...
        <textarea name="body" id="body" rows="4"
          class="hidden @error('body')
					bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
					@enderror p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
