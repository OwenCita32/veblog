@if (Session::has('success'))
  <div class="flex justify-center">
    <div id="toast-success"
      class="absolute top-40 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800"
      role="alert">
      <div
...
<section class="p-3 sm:p-5 antialiased">
  <h2 class="text-xl font-semibold pl-3 mb-3">Post by: {{ Auth::user()->name }}</h2>
            ...
            @foreach ($posts as $post)
              <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-4 py-3 flex items-center justify-end">
                  <button id="post-{{ $post->id }}-imac-27-dropdown-button"
                    data-dropdown-toggle="post-{{ $post->id }}-imac-27-dropdown"
                  ...
                  <div id="post-{{ $post->id }}-imac-27-dropdown"
										class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                    <ul class="py-1 text-sm" aria-labelledby="post-{{ $post->id }}-imac-27-dropdown-button">
											<li>
